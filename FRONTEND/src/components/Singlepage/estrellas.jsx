...
const Radio = ({ valor = 5, onChange, editable = true }) => {
  // valor: número de estrellas seleccionadas (1-5)
  // editable: si es false, solo muestra las estrellas seleccionadas
  return (
    <StyledWrapper>
            ...
            {editable ? (
              ...
              <span>
                <svg
                  ...
                  viewBox="0 0 24 24"
                  style={{
                    fill: star <= valor ? '#ffc73a' : 'transparent',
                    stroke: '#666',
                    width: '2rem',
                    height: '2rem',
                  }}
