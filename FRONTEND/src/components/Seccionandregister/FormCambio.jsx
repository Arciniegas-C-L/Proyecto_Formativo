...
export function VerificarCodigo({ correo }) {
  ...
  const verificarCodigo = async (e) => {
    ...
    try {
      const res = await fetch("http://127.0.0.1:8000/BACKEND/api/usuario/verificar_codigo/", {
        method: "POST",
  ...
  const cambiarContrasena = async (e) => {
    ...
    try {
      const res = await fetch("http://127.0.0.1:8000/BACKEND/api/usuario/reset_password/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
