...
export function ListaRol() {
    ...
    return <div className="container mt-5">
        <div className="d-flex justify-content-around mb-4">
            <h3>Roles</h3>
            <Link to="/rol-create" className="text-decoration-none btn btn-outline-success">Crear Rol</Link>
        </div>
                ...
                <tbody>
                    {roles.map((rol) => (
                        <tr key={rol.idROL} className="justify-content-around">
                            ...
                            <td className="py-3 px-2 align-center border text-center"><Link to={`/rol-edit/${rol.idROL}`} className="text-decoration-none btn btn-warning">Editar</Link></td>
                        </tr>
                    ))}
